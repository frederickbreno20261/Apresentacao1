...
author: "Frederick (<fchame@id.uff.br>) <br> Breno (<seuemail2@id.uff.br>)"
date: today
...
# **CAPÍTULO 1: INTRODUÇÃO**{data-background-image="Capa.png" style="text-align:center"}
...
::: box-blue
- A adolescência é um período de maturação do sistema nervoso e mudanças biológicas e sociais, tornando-a vulnerável a distúrbios do sono.
- O uso excessivo de tecnologia e mídias pode dificultar a ação reparadora do sono e gerar manifestações dolorosas.
- Existe uma sobreposição entre dores musculoesqueléticas (DME) e qualidade de sono, configurando um processo biopsicossocial.
:::
...
# **CAPÍTULO 2: METODOLOGIA ESTATÍSTICA**{data-background-image="Capa.png" style="text-align:center"}
...
- **Sociodemográficas:** Idade, sexo e escolaridade.
:::
...
# **CAPÍTULO 3: RESULTADOS**{data-background-image="Capa.png" style="text-align:center"}
...
A prevalência de dor (geral) na amostra foi de **87,5%**.

# **CAPÍTULO 4: CONCLUSÃO**{data-background-image="Capa.png" style="text-align:center"}
